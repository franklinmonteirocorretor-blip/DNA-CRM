...
- Name: fluxo-completo.spec.ts >> Fluxo Completo — Lead → Pós-venda >> Acessa dashboard e verifica elementos principais
- Location: tests\e2e\fluxo-completo.spec.ts:30:7
