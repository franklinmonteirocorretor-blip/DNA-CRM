...
- Name: fluxo-completo.spec.ts >> Fluxo Completo — Lead → Pós-venda >> ETAPA 1 — Novo Lead: Cadastra cliente via formulário
- Location: tests\e2e\fluxo-completo.spec.ts:40:7
