...
export default function PipelineColuna({
  ...
  return (
    ...
    >
      {/* Cabeçalho da coluna */}
      <div className="px-3 py-2 border-b border-gray-200 dark:border-gray-600" style={{ backgroundColor: config.cor + '15' }}>
        ...
        <div className="flex items-center justify-between mt-1">
          <span className="text-[10px] text-gray-400 dark:text-gray-500">{config.desc.slice(0, 40)}</span>
          <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400">{cards.length}</span>
        </div>
      </div>
