  ...
  return (
    <div className="flex gap-4">
      <div className="w-12 shrink-0 text-right">
        <p className="text-[11px] text-gray-500 dark:text-gray-400">{formatarData(evento.data)}</p>
      </div>
      ...
      <div className="relative flex items-start gap-3 pb-6">
        ...
        <div className="rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 px-3 py-2 flex-1">
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold text-gray-900 dark:text-gray-100">{evento.titulo}</span>
            <span className="text-[10px] text-gray-400 dark:text-gray-500">{evento.usuarioNome}</span>
          </div>
