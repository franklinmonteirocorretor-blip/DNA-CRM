  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{item.nome}</p>
      ...
      {tabela.length > 0 && (
        <div className="overflow-x-auto">
          <table className="min-w-full text-xs">
            ...
            <tbody>
              {tabela.map((item) => (
                <tr key={item.usuarioId} className="border-b border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-300">
