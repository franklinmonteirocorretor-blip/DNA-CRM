  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-xl max-h-[90vh] overflow-y-auto p-6">
        ...
        <div className="mb-4">
          <h3 className="text-sm font-semibold text-gray-700 mb-2">Condicoes</h3>
          ...
          {conds.map((c, i) => (
            <div key={i} className="text-xs bg-gray-50 border rounded px-2 py-1 mb-1 flex justify-between items-center">
        ...
        <div className="mb-4">
          <h3 className="text-sm font-semibold text-gray-700 mb-2">Acoes</h3>
          ...
          {acts.map((a, i) => (
            <div key={i} className="text-xs bg-gray-50 border rounded px-2 py-1 mb-1 flex justify-between mt-1 items-center">
              <span>{a.acao}</span>
        ...
        <div className="flex justify-end gap-3 mt-4 pt-4 border-t">
          <button type="button" className="px-4 py-2 text-sm text-gray-600 border rounded-md" onClick={onClose} disabled={saving}>Cancelar</button>
