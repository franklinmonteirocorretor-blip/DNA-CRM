      ...
      <div className="mt-3 space-y-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4">
            ...
            {(['vendas', 'aprovacoes', 'agendamentos', 'comparecimentos', 'pastas'] as const).map((k) => {
              ...
              return (
                <div key={k} className="text-center">
                  ...
                  <p className="text-lg font-bold text-gray-700">{real}</p>
                  <p className="text-[10px] text-gray-400">/ {meta}</p>
                  <div className="mt-1 h-1.5 bg-gray-100 rounded-full overflow-hidden mx-auto max-w-[80px]">
          ...
          <div className="mt-3 flex items-center justify-between">
            <span className="text-xs text-gray-500">Progresso da equipe</span>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400">{dados.diasRestantes} dias restantes</p>
            </div>
