            ...
            <div className="grid grid-cols-3 gap-2">
              {TIPOS.map((t) => (
                <button
                  ...
                  className={`flex flex-col items-center justify-center rounded-lg border px-3 py-3 text-xs font-medium transition ${
                    tipo === t.valor
        ...
        <div className="mt-3 flex gap-2">
          {TIPOS.map((t) => (
            <button
              ...
              disabled={enviando}
              className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-medium text-gray-600 shadow-sm hover:border-gray-300 hover:bg-gray-50 disabled:opacity-50"
            >
              <span>{t.icone}</span>
              <span>{t.label}</span>
            </button>
