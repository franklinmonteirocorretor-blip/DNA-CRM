...
export function CopilotResumo({ resumo }: ResumoProps) {
  ...
  return (
    <section className="mb-6 rounded-lg bg-white p-5 shadow-sm border">
      {/* Saudação */}
      <h2 className="text-lg font-bold text-gray-900">{resumo.titulo}</h2>
      <p className="mt-1 text-sm text-gray-600">{resumo.saudacao}</p>
